...
var BookAuthorWhere = struct {
	...
	ID:        whereHelperint64{field: "\"book_authors\".\"id\""},
	BooksID:   whereHelperstring{field: "\"book_authors\".\"books_id\""},
	AuthorsID: whereHelperint64{field: "\"book_authors\".\"authors_id\""},
}
...
var (
	bookAuthorAllColumns            = []string{"id", "books_id", "authors_id"}
	bookAuthorColumnsWithoutDefault = []string{"books_id", "authors_id"}
	bookAuthorColumnsWithDefault    = []string{"id"}
...
func (q bookAuthorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*BookAuthor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: failed to execute a one query for book_authors")
	}
...
func (q bookAuthorQuery) All(ctx context.Context, exec boil.ContextExecutor) (BookAuthorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "record: failed to assign all query results to BookAuthor slice")
	}
...
func (q bookAuthorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to count book_authors rows")
	}
...
func (q bookAuthorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "record: failed to check if book_authors exists")
	}
...
func (bookAuthorL) LoadBook(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookAuthor interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.BooksID)
...
func (bookAuthorL) LoadAuthor(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBookAuthor interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.AuthorsID)
	...
	Outer:
		for _, obj := range slice {
			...
			args = append(args, obj.AuthorsID)
	...
	query := NewQuery(qm.From(`authors`), qm.WhereIn(`authors.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *BookAuthor) SetBook(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Book) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"book_authors\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 1, []string{"books_id"}),
...
func (o *BookAuthor) SetAuthor(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Author) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"book_authors\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 1, []string{"authors_id"}),
		strmangle.WhereClause("\"", "\"", 2, bookAuthorPrimaryKeyColumns),
	)
	values := []interface{}{related.ID, o.ID}
...
func FindBookAuthor(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*BookAuthor, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"book_authors\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "record: unable to select from book_authors")
	}
...
func (o *BookAuthor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("record: no book_authors provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to insert into book_authors")
	}
...
func (o *BookAuthor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("record: unable to update book_authors, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update book_authors row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by update for book_authors")
	}
...
func (q bookAuthorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all for book_authors")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected for book_authors")
	}
...
func (o BookAuthorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to update all in bookAuthor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to retrieve rows affected all in update all bookAuthor")
	}
	return rowsAff, nil
}
...
func (o *BookAuthor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("record: no book_authors provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("record: unable to upsert book_authors, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to upsert book_authors")
	}
...
func (o *BookAuthor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("record: no BookAuthor provided for delete")
	}
	...
	sql := "DELETE FROM \"book_authors\" WHERE \"id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete from book_authors")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by delete for book_authors")
	}
...
func (q bookAuthorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("record: no bookAuthorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from book_authors")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "record: failed to get rows affected by deleteall for book_authors")
	}
...
func (o BookAuthorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "record: unable to delete all from bookAuthor slice")
	}
...
func (o *BookAuthorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "record: unable to reload all in BookAuthorSlice")
	}
...
func BookAuthorExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"book_authors\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "record: unable to check if book_authors exists")
	}
