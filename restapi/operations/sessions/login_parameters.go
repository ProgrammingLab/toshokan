...
type LoginParams struct {
	...
	/*メールアドレスとパスワード
	  ...
	  In: body
	*/
	EmailAndPassword *models.EmailAndPassword
}
...
func (o *LoginParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("emailAndPassword", "body"))
			} else {
				res = append(res, errors.NewParseError("emailAndPassword", "body", "", err))
			}
		} else {
