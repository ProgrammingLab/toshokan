...
// NewToshokanAPI creates a new Toshokan instance
func NewToshokanAPI(spec *loads.Document) *ToshokanAPI {
	return &ToshokanAPI{
...
/*ToshokanAPI プロラボの図書館理システムです。 */
type ToshokanAPI struct {
	spec            *loads.Document
...
func (o *ToshokanAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *ToshokanAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *ToshokanAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *ToshokanAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *ToshokanAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *ToshokanAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *ToshokanAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the ToshokanAPI
func (o *ToshokanAPI) Validate() error {
...
func (o *ToshokanAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}
...
func (o *ToshokanAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *ToshokanAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *ToshokanAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the toshokan API
func (o *ToshokanAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *ToshokanAPI) initHandlerCache() {
...
func (o *ToshokanAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *ToshokanAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *ToshokanAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
